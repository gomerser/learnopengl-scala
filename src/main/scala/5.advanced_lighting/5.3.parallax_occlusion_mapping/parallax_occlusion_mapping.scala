...
@main def main(): Unit =
  ...
  val shader =
    Shader(
      "5.advanced_lighting/5.3.parallax_mapping.vs",
      "5.advanced_lighting/5.3.parallax_mapping.fs"
    )

  // load textures
  // -------------
  val diffuseMap = loadTexture("/textures/bricks2.jpg")
  val normalMap = loadTexture("/textures/bricks2_normal.jpg")
  val heightMap = loadTexture("/textures/bricks2_disp.jpg")
  /* val diffuseMap = loadTexture("/textures/toy_box_diffuse.png")
  val normalMap = loadTexture("/textures/toy_box_normal.png")
  val heightMap = loadTexture("/textures/toy_box_disp.png") */
