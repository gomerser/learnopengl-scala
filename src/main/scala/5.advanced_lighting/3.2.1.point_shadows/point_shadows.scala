...
@main def main(): Unit =
  ...
  // -------------------------
  val shader = Shader(
    "5.advanced_lighting/3.2.1.point_shadows.vs",
    "5.advanced_lighting/3.2.1.point_shadows.fs"
  )
  val simpleDepthShader = Shader(
    "5.advanced_lighting/3.2.1.point_shadows_depth.vs",
    "5.advanced_lighting/3.2.1.point_shadows_depth.fs",
    "5.advanced_lighting/3.2.1.point_shadows_depth.gs"
  )
