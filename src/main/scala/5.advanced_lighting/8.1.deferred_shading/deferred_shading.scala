...
@main def main(): Unit =
  ...
  val shaderGeometryPass =
    Shader(
      "5.advanced_lighting/8.1.g_buffer.vs",
      "5.advanced_lighting/8.1.g_buffer.fs"
    )
  val shaderLightingPass =
    Shader(
      "5.advanced_lighting/8.1.deferred_shading.vs",
      "5.advanced_lighting/8.1.deferred_shading.fs"
    )
  val shaderLightBox =
    Shader(
      "5.advanced_lighting/8.1.deferred_light_box.vs",
      "5.advanced_lighting/8.1.deferred_light_box.fs"
    )
