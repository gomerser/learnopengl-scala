...
@main def main(): Unit =
  ...
  // -------------------------
  val shader = Shader(
    "5.advanced_lighting/3.1.2.shadow_mapping.vs",
    "5.advanced_lighting/3.1.2.shadow_mapping.fs"
  )
  val simpleDepthShader = Shader(
    "5.advanced_lighting/3.1.2.shadow_mapping_depth.vs",
    "5.advanced_lighting/3.1.2.shadow_mapping_depth.fs"
  )
  val debugDepthQuad = Shader(
    "5.advanced_lighting/3.1.2.debug_quad.vs",
    "5.advanced_lighting/3.1.2.debug_quad_depth.fs"
  )
