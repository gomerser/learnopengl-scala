...
@main def main(): Unit =
  ...
  val shader =
    Shader(
      "4.advanced_opengl/2.stencil_testing.vs",
      "4.advanced_opengl/2.stencil_testing.fs"
    )
  val shaderSingleColor =
    Shader(
      "4.advanced_opengl/2.stencil_testing.vs",
      "4.advanced_opengl/2.stencil_single_color.fs"
    )
