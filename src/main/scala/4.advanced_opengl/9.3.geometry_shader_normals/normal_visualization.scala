...
@main def main(): Unit =
  ...
  // ------------------------------------
  val shader = Shader(
    "4.advanced_opengl/9.3.default.vs",
    "4.advanced_opengl/9.3.default.fs"
  )
  val normalShader = Shader(
    "4.advanced_opengl/9.3.normal_visualization.vs",
    "4.advanced_opengl/9.3.normal_visualization.fs",
    "4.advanced_opengl/9.3.normal_visualization.gs"
  )
