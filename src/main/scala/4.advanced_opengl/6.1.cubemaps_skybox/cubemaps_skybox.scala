...
@main def main(): Unit =
  ...
  val shader =
    Shader(
      "4.advanced_opengl/6.1.cubemaps.vs",
      "4.advanced_opengl/6.1.cubemaps.fs"
    )
  val skyboxShader =
    Shader(
      "4.advanced_opengl/6.1.skybox.vs",
      "4.advanced_opengl/6.1.skybox.fs"
    )
