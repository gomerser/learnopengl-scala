...
@main def main(): Unit =
  ...
  val shader =
    Shader(
      "4.advanced_opengl/5.1.framebuffers.vs",
      "4.advanced_opengl/5.1.framebuffers.fs"
    )
  val screenShader =
    Shader(
      "4.advanced_opengl/5.1.framebuffers_screen.vs",
      "4.advanced_opengl/5.1.framebuffers_screen.fs"
    )
