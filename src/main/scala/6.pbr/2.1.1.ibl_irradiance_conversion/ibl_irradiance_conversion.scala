...
@main def main(): Unit =
  ...
  // ------------------------------------
  val pbrShader = Shader("6.pbr/2.1.1.pbr.vs", "6.pbr/2.1.1.pbr.fs")
  val equirectangularToCubemapShader = Shader(
    "6.pbr/2.1.1.cubemap.vs",
    "6.pbr/2.1.1.equirectangular_to_cubemap.fs"
  )
  val backgroundShader =
    Shader("6.pbr/2.1.1.background.vs", "6.pbr/2.1.1.background.fs")
