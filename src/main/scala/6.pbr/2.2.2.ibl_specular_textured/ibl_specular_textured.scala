...
@main def main(): Unit =
  ...
  // ------------------------------------
  val pbrShader = Shader("6.pbr/2.2.2.pbr.vs", "6.pbr/2.2.2.pbr.fs")
  val equirectangularToCubemapShader = Shader(
    "6.pbr/2.2.2.cubemap.vs",
    "6.pbr/2.2.2.equirectangular_to_cubemap.fs"
  )
  val irradianceShader = Shader(
    "6.pbr/2.2.2.cubemap.vs",
    "6.pbr/2.2.2.irradiance_convolution.fs"
  )
  val prefilterShader =
    Shader("6.pbr/2.2.2.cubemap.vs", "6.pbr/2.2.2.prefilter.fs")
  val brdfShader =
    Shader("6.pbr/2.2.2.brdf.vs", "6.pbr/2.2.2.brdf.fs")
  val backgroundShader =
    Shader("6.pbr/2.2.2.background.vs", "6.pbr/2.2.2.background.fs")
  ...
  // --------------------------
  // rusted iron
  val ironAlbedoMap = loadTexture("/textures/pbr/rusted_iron/albedo.png")
  val ironNormalMap = loadTexture("/textures/pbr/rusted_iron/normal.png")
  val ironMetallicMap = loadTexture("/textures/pbr/rusted_iron/metallic.png")
  val ironRoughnessMap = loadTexture("/textures/pbr/rusted_iron/roughness.png")
  val ironAOMap = loadTexture("/textures/pbr/rusted_iron/ao.png")

  // gold
  val goldAlbedoMap = loadTexture("/textures/pbr/gold/albedo.png")
  val goldNormalMap = loadTexture("/textures/pbr/gold/normal.png")
  val goldMetallicMap = loadTexture("/textures/pbr/gold/metallic.png")
  val goldRoughnessMap = loadTexture("/textures/pbr/gold/roughness.png")
  val goldAOMap = loadTexture("/textures/pbr/gold/ao.png")

  // grass
  val grassAlbedoMap = loadTexture("/textures/pbr/grass/albedo.png")
  val grassNormalMap = loadTexture("/textures/pbr/grass/normal.png")
  val grassMetallicMap = loadTexture("/textures/pbr/grass/metallic.png")
  val grassRoughnessMap = loadTexture("/textures/pbr/grass/roughness.png")
  val grassAOMap = loadTexture("/textures/pbr/grass/ao.png")

  // plastic
  val plasticAlbedoMap = loadTexture("/textures/pbr/plastic/albedo.png")
  val plasticNormalMap = loadTexture("/textures/pbr/plastic/normal.png")
  val plasticMetallicMap = loadTexture("/textures/pbr/plastic/metallic.png")
  val plasticRoughnessMap = loadTexture("/textures/pbr/plastic/roughness.png")
  val plasticAOMap = loadTexture("/textures/pbr/plastic/ao.png")

  // wall
  val wallAlbedoMap = loadTexture("/textures/pbr/wall/albedo.png")
  val wallNormalMap = loadTexture("/textures/pbr/wall/normal.png")
  val wallMetallicMap = loadTexture("/textures/pbr/wall/metallic.png")
  val wallRoughnessMap = loadTexture("/textures/pbr/wall/roughness.png")
  val wallAOMap = loadTexture("/textures/pbr/wall/ao.png")
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    var model = new Matrix4f()
      .translate(Vector3f(-5.0, 0.0, 2.0))
    ...
    model = new Matrix4f()
      .translate(Vector3f(-3.0, 0.0, 2.0))
    pbrShader.setMat4("model", model)
    pbrShader.setMat3("normalMatrix", Matrix3f(model).invert.transpose)
    renderSphere()
    ...
    model = new Matrix4f()
      .translate(Vector3f(-1.0, 0.0, 2.0))
    pbrShader.setMat4("model", model)
    pbrShader.setMat3("normalMatrix", Matrix3f(model).invert.transpose)
    renderSphere()
