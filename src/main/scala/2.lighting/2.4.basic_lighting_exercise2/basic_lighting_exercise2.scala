...
@main def main(): Unit =
  ...
  val lightingShader = Shader(
    "2.lighting/2.2.basic_lighting.vs",
    "2.lighting/2.2.basic_lighting.fs"
  )
  val lightCubeShader =
    Shader("2.lighting/2.4.light_cube.vs", "2.lighting/2.4.light_cube.fs")
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    lightPos.x = 1.0f + math.sin(glfwGetTime()).toFloat * 2.0f
    lightPos.y = math.sin(glfwGetTime() / 2.0f).toFloat * 1.0f
