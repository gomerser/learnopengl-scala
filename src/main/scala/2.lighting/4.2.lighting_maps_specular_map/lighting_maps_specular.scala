...
@main def main(): Unit =
  ...
  val lightingShader = Shader(
    "2.lighting/4.2.lighting_maps.vs",
    "2.lighting/4.2.lighting_maps.fs"
  )
  val lightCubeShader =
    Shader("2.lighting/4.2.light_cube.vs", "2.lighting/4.2.light_cube.fs")
