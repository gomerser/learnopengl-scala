...
@main def main(): Unit =
  ...
  val lightingShader = Shader(
    "2.lighting/5.2.light_casters.vs",
    "2.lighting/5.2.light_casters.fs"
  )
  val lightCubeShader =
    Shader("2.lighting/5.2.light_cube.vs", "2.lighting/5.2.light_cube.fs")
